...
public void init() {
	...
	for (module in allmodules) {
		...
		QueryBuilder query = archive.query(module.getId()).exists("entityembeddingstatus");
		...
		for(data in rows) 
		{
			...
			row.setValue("entityembeddingstatus", "notembedded"); // TODO: delete previous embedding
