...
var editorCanvas;
var ctx;
lQuery("#editingCandidate").livequery(function (e) {
  ...
  img.onload = function () {
    ...
    ctx.drawImage(
      ...
      img.width,
      img.height,
      centerShift_x + padding / 2,
      centerShift_y + padding / 2,
      img.width * ratio - padding,
      img.height * ratio - padding
    );
  };
});

lQuery(".editorarea").livequery(function () {
  $(this)
    .find("a")
    .click(function (e) {
      e.preventDefault();
...
jQuery(document).ready(function () {
  ...
  lQuery("#icons-container").livequery(function () {
