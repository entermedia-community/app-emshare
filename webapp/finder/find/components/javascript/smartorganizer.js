...
$(document).ready(function () {
  ...
  lQuery("#organizer_canvas").livequery(function () {
    ...
    lQuery("#iconsList").livequery(function () {
      var icHtm = "";
      bsIcons = JSON.parse(bsIcons);
      for (var i = 0; i < bsIcons.length; i++) {
        icHtm += `<button type="button" class="btn btn-dark"><img src="${apphome}/components/smartorganizer/icons/${bsIcons[i]}.svg" loading="lazy"/></button>`;
      }
      $(this).html(icHtm);
