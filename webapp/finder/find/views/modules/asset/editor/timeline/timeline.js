...
$(document).ready(function () {
	...
	var video = $("#video-container").find("video")[0];
	...
	updateDetails = function (jumptoend) {
		...
		var source =
			"/" +
			mediadbappid +
			"/services/module/asset/downloads/converted/cache/" +
			sourcepath +
			"/video.mp4";
...
*/
	...
	if (jump) {
		...
		var selectedc = $(
			".data-selection" + '[data-timecodestart="' + jump + '"]'
		);
